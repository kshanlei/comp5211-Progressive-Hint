...
prompt_base=prompt/cot/cot_base_aqua.txt
prompt_hint=prompt/cot/cot_PHP_aqua.txt
...
prompt_base=prompt/cot/cot_base_gsm8k.txt
prompt_hint=prompt/cot/cot_PHP_gsm8k.txt
